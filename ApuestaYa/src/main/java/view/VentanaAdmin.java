						...
						BoxLayout.Y_AXIS));
				{
					...
					}
					{
						...
						panelTenis.add(centralTenis, BorderLayout.CENTER);
						{
							...
							preguntaTenis
									.addItem("¿Cuántos sets durará el partido?");
							preguntaTenis.addItem("¿Quién hará más ace's?");
						}
						{
				...
				}
				{
					...
					}
					{
						...
						panelFutbol.add(centralFutbol, BorderLayout.CENTER);
						{
							...
							preguntaFutbol
									.addItem("¿Quién será el primer goleador?");
							preguntaFutbol
									.addItem("¿En qué minuto se marcara el primer gol?");
						}
						{
				...
				}
				{
					...
					}
					{
						...
						panelFormula.add(centralF1, BorderLayout.CENTER);
						{
							...
							preguntaF1
									.addItem("¿Quién quedará el última posición");
							preguntaF1
									.addItem("¿Quién hará la vuelta más rápida?");
						}
						{
